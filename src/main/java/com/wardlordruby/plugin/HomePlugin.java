...
public class HomePlugin extends JavaPlugin {
    ...
    public HomePlugin(@Nonnull JavaPluginInit init) {
        ...
        playerCache = config.enabledModules.offlinePlayerCache ? new PlayerCache(fileManager.read(JsonResource.PLAYER_CACHE)) : null;
    ...
    protected void shutdown() {
        ...
        if (config.enabledModules.offlinePlayerCache) {
            fileManager.write(Objects.requireNonNull(playerCache), JsonResource.PLAYER_CACHE);
        }
